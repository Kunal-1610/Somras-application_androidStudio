...
public class ViewcategoryAdapt extends RecyclerView.Adapter <ViewcategoryAdapt.myViewHolder>
{
    int aar [];
    String []icode;
    String []iname;
    ...
    String []irate;
    Context context;
    public ViewcategoryAdapt(Context context , String[] icode, int[] aar, String[] iname, String[] irate, String[] iunit, String[] icategory)
    {
        this.aar = aar;
        this.icode = icode;
        this.iname = iname;
...
//        Toast.makeText(context, iname[1], Toast.LENGTH_SHORT).show();
